...
public class MealsUtil {
    ...
    public static final List<Meal> meals = Arrays.asList(
            ...
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 28, 10, 0), "Завтрак", 2100, 1),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 28, 13, 0), "Обед", 1500, 1),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 28, 20, 0), "Ужин", 799, 2)
    );
