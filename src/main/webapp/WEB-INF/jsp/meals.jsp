    ...
    <table border="1" cellpadding="8" cellspacing="0">
        ...
        <c:forEach items="${requestScope.meals}" var="meal">
            <tr data-mealExcess="${meal.excess}">
                ...
                <td>${meal.calories}</td>
                <td><a href="${pageContext.request.contextPath}/meals/update/${meal.id}"><spring:message code="meal.table.update"/></a></td>
                <td><a href="${pageContext.request.contextPath}/meals/delete/${meal.id}"><spring:message code="meal.table.delete"/></a></td>
            </tr>
        </c:forEach>
    </table>
</section>
